...
const roundHumidity = (humidity) => {
    return parseFloat(humidity.toFixed(0));
}

const roundPressure = (pressure) => {
    return parseFloat(pressure.toFixed(0));
}

const roundWindSpeed = (windSpeed) => {
...
export default {
    ...
    createHistoricalCharts: function(data) {
        ...
        this.createTemperatureChart(chartOptions, seriesTemperature, seriesDewpoint);
        this.createHumidityChart(chartOptions, seriesHumidity);
        this.createPressureChart(chartOptions, seriesPressure);
        this.createWindChart(chartOptions, seriesWind);
    },

    createTemperatureChart: function(chartOptions, seriesTemperature, seriesDewpoint) {
    ...
    createHumidityChart: function(chartOptions, seriesHumidity) {
    ...
    createPressureChart: function(chartOptions, seriesPressure) {
    ...
    createWindChart: function(chartOptions, seriesWind) {
